(function () {
  ...
  function clearAllErrors(form) {
    ["member_id", "full_address", "city", "district", "ward", "type"].forEach(
      function (name) {
  ...
  function initForm(form) {
    ...
    loadAddressData().then(function (data) {
      ...
      var selectedProvince =
        provinceSelect.value || form.dataset.initialProvince || "";
      var selectedDistrict =
        districtSelect.value || form.dataset.initialDistrict || "";
  ...
  function fillForm(form, data) {
    ...
    if (defaultField)
      defaultField.checked =
        String(data.is_default) === "1" ||
        data.is_default === 1 ||
