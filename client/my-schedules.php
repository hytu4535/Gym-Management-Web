...
// 2. Lấy thông tin từ bảng members
            ...
            <div class="col-lg-3">
                <div class="profile-sidebar">
                    ...
                    <div class="sidebar-menu">
                        ...
                        <a href="my-schedules.php" class="sidebar-item active">
                ...
                <div class="profile-content" style="background-color: aliceblue; padding: 30px; border-radius: 8px;">
                    ...
                    <div id="tab-pt" class="tab-content active">
                        ...
                        <?php if ($ts_result && $ts_result->num_rows > 0): ?>
                            ...
                            <?php endwhile; ?>
                        <?php else: ?>
                        <div style="text-align:center;padding:40px;color:#888;background:#fff;border-radius:8px;">
                            <i class="fa fa-calendar-times-o fa-3x" style="color:#ddd;"></i>
                            <p style="margin-top:15px;">Chưa có lịch hẹn nào với PT.</p>
                            <a href="pt-booking.php" class="site-btn" style="display:inline-block;padding:10px 24px;margin-top:10px;">
