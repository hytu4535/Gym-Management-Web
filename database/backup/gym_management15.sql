...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Đăng ký lớp tập nhóm';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `class_schedules` VALUES (1,'Yoga Sáng Năng Động','yoga',1,'01:04:00','04:04:00','Thứ 2, Thứ 4, Thứ 6',25,0,'Phòng A1','active','2026-03-07 22:44:36'),(2,'Cardio Giảm Cân','cardio',2,NULL,NULL,'Thứ 3, Thứ 5, Thứ 7',30,1,'Phòng B2','active','2026-03-07 22:44:36'),(3,'Boxing Cơ Bản','boxing',1,NULL,NULL,'Thứ 2, Thứ 5',15,2,'Phòng C1','active','2026-03-07 22:44:36'),(4,'HIIT Đốt Mỡ','hiit',2,NULL,NULL,'Thứ 3, Thứ 6',20,0,'Phòng B1','active','2026-03-07 22:44:36'),(5,'Strength Training','strength',1,NULL,NULL,'Thứ 4, Thứ 7, Chủ Nhật',18,1,'Phòng Gym','active','2026-03-07 22:44:36');
...
INSERT INTO `departments` VALUES (1,'Lễ tân'),(2,'Huấn luyện viên'),(3,'Quản lý');
...
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Lịch tập cá nhân của hội viên';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `role_permissions` VALUES (4,1),(7,1),(5,2),(5,4),(5,7),(5,10),(9,12);
...
INSERT INTO `roles` VALUES (4,'admin','Quản trị toàn hệ thống','active'),(5,'staff','Nhân viên hỗ trợ khách hàng','active'),(6,'member','Hội viên sử dụng dịch vụ','active'),(7,'aaaaaaaaaa','aaaaaaaaaaa','active'),(8,'z','z','active'),(9,'abc','aaa','active');
...
INSERT INTO `staff` VALUES (1,13,'Phạm Văn Đức',NULL,NULL,'Nhân viên lễ tân',NULL,'active','2026-03-28 03:26:42','2026-03-28 03:26:42'),(2,14,'Hoàng Thị Lan',NULL,NULL,'Nhân viên tư vấn',NULL,'active','2026-03-28 03:26:42','2026-03-28 03:26:42'),(3,20,'Nguyễn Minh Tuấn',NULL,NULL,'Nhân viên kỹ thuật',NULL,'active','2026-03-28 03:26:42','2026-03-28 03:26:42'),(4,21,'Trần Thanh Hương',NULL,NULL,'Nhân viên chăm sóc khách hàng',NULL,'active','2026-03-28 03:26:42','2026-03-28 03:26:42'),(5,22,'Lê Văn Hải',NULL,NULL,'Quản lý ca',NULL,'active','2026-03-28 03:26:42','2026-03-28 03:26:42');
...
-- Dump completed on 2026-03-28  3:27:24
