...
CREATE TABLE `bmi_devices` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Máy đo BMI';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `bmi_devices` VALUES (2,'BMI - 07','Tầng 1 - Khu C','active','2026-02-15 11:56:16'),(3,'BMI - 01','Tầng 2','active','2026-02-15 11:56:30'),(8,'BMI - 08','Tầng 1 - Khu B','active','2026-03-29 16:23:52');
...
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Lịch sử đo BMI của hội viên';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `bmi_measurements` VALUES (4,3,2,165.00,70.00,25.71,'thua can','2026-02-15 11:57:49'),(8,2,3,180.00,70.00,21.60,'binh thuong','2026-03-07 23:10:55'),(14,3,2,175.00,75.00,24.49,'binh thuong','2026-03-29 16:24:18'),(15,1,2,175.00,100.00,32.65,'beo phi','2026-03-29 16:24:39');
...
INSERT INTO `import_details` VALUES (1,1,1,NULL,2,26000000.00),(2,2,NULL,1,10,1500000.00),(3,4,NULL,19,10,800001.00),(4,6,NULL,18,15,500001.00),(5,6,NULL,13,5,185001.00),(6,7,NULL,19,12,800000.00),(7,8,NULL,19,100,1000000.00),(8,9,NULL,19,30,1000000.00);
...
INSERT INTO `member_packages` VALUES (1,13,1,'2025-02-06','2025-03-06','active'),(2,3,2,'2026-02-10','2026-05-10','active'),(3,1,3,'2026-03-18','2026-09-18','active'),(4,1,2,'2026-03-22','2026-06-22','active'),(5,1,4,'2026-03-25','2027-03-25','active'),(6,19,7,'2026-03-25','2026-04-25','active'),(7,27,3,'2026-03-29','2026-09-29','active'),(8,27,7,'2026-03-12','2028-03-12','active'),(9,27,7,'2026-03-12','2028-03-12','active'),(10,27,7,'2026-03-12','2028-03-12','active'),(11,32,2,'2026-03-29','2026-06-29','active');
...
-- Dump completed on 2026-03-30 15:07:48
