...
INSERT INTO `member_packages` VALUES (1,13,1,'2025-02-06','2025-03-06','cancelled'),(2,3,2,'2026-02-10','2026-05-10','active'),(3,1,3,'2026-03-18','2026-09-18','active'),(4,1,2,'2026-03-22','2026-06-22','active'),(5,1,4,'2026-03-25','2027-03-25','active'),(6,19,7,'2026-03-25','2026-04-25','active'),(7,27,3,'2026-03-29','2026-09-29','active'),(8,27,7,'2026-03-12','2028-03-12','active'),(9,27,7,'2026-03-12','2028-03-12','active'),(10,27,7,'2026-03-12','2028-03-12','active'),(11,32,2,'2026-03-29','2026-06-29','active'),(13,36,12,'2026-03-30','2026-04-30','cancelled'),(15,36,12,'2026-03-31','2026-08-31','active'),(16,25,15,'2026-03-31','2026-07-01','cancelled'),(17,25,7,'2026-03-31','2029-02-19','active');
...
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Hội viên sử dụng dịch vụ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `nutrition_plans` (
  ...
  `status` enum('hoạt động','không hoạt động') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'hoạt động',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Chế độ dinh dưỡng & tư vấn';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `role_permissions` VALUES (4,1),(4,2),(11,2),(4,3),(11,3),(4,4),(11,4),(4,5),(11,5),(4,6),(11,6),(4,7),(11,7),(4,8),(11,8),(15,8),(4,9),(11,9),(4,10),(11,10),(4,11),(11,11),(4,12),(11,12);
...
INSERT INTO `services` VALUES (3,'Massage phục hồi sau tập','assets/uploads/services/service_1774445517_3e958b4e.jpg','xoa bóp',100000.00,'Tập hết mình, relax hết cỡ! Dịch vụ mát-xa tại gym giúp bạn giảm đau cơ, thư giãn tức thì và phục hồi nhanh hơn. Không gian chill, kỹ thuật viên chuyên nghiệp.','hoạt động'),(4,'Xông hơi sauna – thư giãn chuẩn gym','assets/uploads/services/service_1774445765_fb6ca8a3.jpg','thư giãn',120000.00,'Giải nhiệt sau buổi tập với phòng xông hơi hiện đại, giúp thải độc, giảm căng cơ và thư giãn cực đã. Không gian sạch đẹp, ấm áp – “reset” cơ thể nhanh chóng.','hoạt động'),(5,'xông hơi Sauna + anh Kiên massage','assets/uploads/services/service_1774445956_0a536abf.jpg','thư giãn',5000000.00,'Xông hơi sauna giúp thải độc, giảm căng cơ, thư giãn cực đã sau buổi tập. Sau đó được anh Kiên trực tiếp massage, đánh tan đau mỏi, làm xong nhẹ người liền.','hoạt động'),(7,'zzzzzzzzz','assets/uploads/services/service_1774952842_95765c80.jpg','thư giãn',444444.00,'zzzzzzzzkk','không hoạt động');
...
-- Dump completed on 2026-04-01  2:16:14
