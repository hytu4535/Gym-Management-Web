...
INSERT INTO `addresses` VALUES (1,13,'18/20 Phan Văn Trị, P5, TP.HCM','TP. HCM','Quận 5',1),(11,1,'45 Nguyễn Trãi, Phường 2','Hồ Chí Minh','Quận 5',1),(12,2,'78 Trần Hưng Đạo','Hà Nội','Hoàn Kiếm',0),(13,2,'12 Nguyễn Chí Thanh','Hà Nội','Đống Đa',0),(14,3,'56 Lý Thường Kiệt','Đà Nẵng','Hải Châu',1),(15,3,'90 Nguyễn Văn Linh','Đà Nẵng','Thanh Khê',0),(26,2,'18/16A Võ Văn Kiệt, Quận 2, TPHCM','TP.HCM','Quận 2',1),(27,2,'56656','TP. HCM','Quận 5',0),(28,18,'1','1','1',0),(30,19,'z','z','z',0),(31,19,'a','a','a',0),(33,3,'zzzzzzz','aaa','aaaaa',0),(36,1,'zxvxzvxzzvxzzzvxz','xzvzvxxzvzxv','zxvzxvzxvxzvxzvz',0),(37,18,'zzzzzzzzzzzzzzzzz','zzzzzzzzzzz','zzzzzzzzzzzzzzz',1),(38,19,'aa','aa','aa',1),(39,19,'a','a','a',0),(40,19,'aaaaa','a','aa',0),(41,25,';llllllllllll','llllllllllllllll','llllllllllllll',1),(42,25,'fffffffff','fffffffff','fffffffffff',0),(43,25,'vvvvvvvvvvv','vvv','vv',0),(44,26,'aaaaa','aaaaaaaa','aaaaaaa',1),(45,27,'s','s','s',1);
...
CREATE TABLE `bmi_devices` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Máy đo BMI';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Lịch sử đo BMI của hội viên';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `bmi_measurements` VALUES (4,3,2,165.00,70.00,25.71,'thua can','2026-02-15 11:57:49'),(8,2,3,180.00,70.00,21.60,'binh thuong','2026-03-07 23:10:55'),(9,1,1,160.00,150.00,58.59,'beo phi','2026-03-25 13:11:59'),(10,1,1,170.00,100.00,34.60,'beo phi','2026-03-25 13:12:27'),(11,1,1,175.00,80.00,26.12,'thua can','2026-03-25 13:12:51'),(12,1,1,175.00,70.00,22.86,'binh thuong','2026-03-25 13:13:25'),(13,1,1,175.00,70.00,22.86,'binh thuong','2026-03-25 13:31:35');
...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Đăng ký lớp tập nhóm';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Lớp tập nhóm';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `import_details` VALUES (1,1,1,NULL,2,26000000.00),(2,2,NULL,1,10,1500000.00),(3,4,NULL,19,10,800001.00),(4,6,NULL,18,15,500001.00),(5,6,NULL,13,5,185001.00),(6,7,NULL,19,12,800000.00),(7,8,NULL,19,100,1000000.00);
...
INSERT INTO `member_nutrition_plans` VALUES (1,2,1,'2026-02-19','2026-02-21','kết thúc'),(2,1,2,'2026-03-18','2026-03-28','đã áp dụng'),(3,19,1,'2026-03-26','2026-04-04','đã áp dụng');
...
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Lịch tập cá nhân của hội viên';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `orders` VALUES (1,1,1,'2026-02-18 09:15:00',250000.00,'cash',NULL,NULL,NULL,'delivered'),(8,1,11,'2026-02-18 18:50:10',100000.00,'cash',NULL,NULL,NULL,'delivered'),(9,2,12,'2026-02-18 11:45:00',125000.00,'cash',NULL,NULL,NULL,'delivered'),(10,2,13,'2026-02-18 13:00:00',99000.99,'online',NULL,NULL,NULL,'confirmed'),(11,3,14,'2026-02-18 14:20:00',760000.00,'cash',NULL,NULL,NULL,'cancelled'),(12,2,NULL,'2026-03-08 05:01:30',1380000.00,'online',NULL,NULL,NULL,'delivered'),(13,2,NULL,'2026-03-08 05:02:31',1380000.00,'cash',NULL,NULL,NULL,'cancelled'),(14,2,27,'2026-03-08 05:05:14',1380000.00,'cash',NULL,NULL,NULL,'pending'),(15,2,NULL,'2026-03-08 05:08:05',1380000.00,'online',NULL,NULL,NULL,'pending'),(16,2,NULL,'2026-03-08 06:08:05',13530000.00,'cash',NULL,NULL,NULL,'delivered'),(17,2,NULL,'2026-03-08 06:12:37',18530000.00,'cash',NULL,NULL,NULL,'cancelled'),(18,2,NULL,'2026-03-08 06:15:07',40000.00,'cash',NULL,NULL,NULL,'pending'),(19,2,NULL,'2026-03-08 06:15:28',40000.00,'cash',NULL,NULL,NULL,'pending'),(20,2,NULL,'2026-03-08 06:16:29',580000.00,'cash',NULL,NULL,NULL,'pending'),(21,1,NULL,'2026-03-11 16:58:19',6780000.00,'cash',NULL,NULL,NULL,'delivered'),(22,1,NULL,'2026-03-11 17:25:47',3492750.00,'cash',NULL,NULL,NULL,'delivered'),(23,1,NULL,'2026-03-11 17:29:29',2217000.00,'cash',NULL,NULL,NULL,'delivered'),(24,3,NULL,'2026-03-11 17:35:28',2082000.00,'cash',NULL,NULL,NULL,'pending'),(25,1,NULL,'2026-03-18 18:51:49',3436500.00,'online',NULL,NULL,NULL,'confirmed'),(26,1,NULL,'2026-03-23 03:00:03',255000.00,'cash',NULL,NULL,NULL,'pending'),(27,1,NULL,'2026-03-23 03:18:59',1350000.00,'cash',NULL,NULL,NULL,'pending'),(28,1,NULL,'2026-03-23 04:10:32',1200000.00,'bank_transfer','TT028IA','order_1774213832_69c05ac8ab9e1.jpg',NULL,'pending'),(29,1,NULL,'2026-03-23 04:13:55',556500.00,'bank_transfer','TT028GN','order_1774214035_69c05b93451ad.jpg',NULL,'delivered'),(30,1,NULL,'2026-03-23 04:15:44',1785000.00,'bank_transfer','TT028LF','order_1774214144_69c05c00a5157.jpg',NULL,'pending'),(31,1,NULL,'2026-03-23 04:17:37',1785000.00,'bank_transfer','TT028VC','order_1774214257_69c05c713271d.jpg',NULL,'pending'),(32,1,NULL,'2026-03-23 04:22:54',7522500.00,'bank_transfer','TT028OM','order_1774214574_69c05daebda06.jpg',NULL,'confirmed'),(33,1,NULL,'2026-03-25 19:59:20',5446625.00,'bank_transfer','TT033HS','order_1774443560_69c3dc2843fd5.jpg',NULL,'pending'),(34,1,NULL,'2026-03-25 22:10:27',1127500.00,'bank_transfer','TT034AY','order_1774451427_69c3fae3b0271.jpg',NULL,'pending'),(35,1,NULL,'2026-03-25 22:11:49',2125000.00,'bank_transfer','TT034IH','order_1774451509_69c3fb3544040.jpg',NULL,'pending'),(36,18,28,'2026-03-25 22:29:16',8130000.00,'bank_transfer','TT034OC','order_1774452556_69c3ff4c9f383.jpg',NULL,'pending'),(37,18,NULL,'2026-03-25 22:38:12',1056000.00,'cash',NULL,NULL,NULL,'confirmed'),(38,18,NULL,'2026-03-25 22:39:48',1056000.00,'cash',NULL,NULL,NULL,'pending'),(39,19,31,'2026-03-26 04:50:44',2724000.00,'cash',NULL,NULL,NULL,'pending'),(40,19,40,'2026-03-26 16:38:23',4580000.00,'cash',NULL,NULL,NULL,'delivered'),(41,25,41,'2026-03-27 11:33:32',1350000.00,'bank_transfer','TT041EE','order_1774586012_69c6089c948e6.jpg',NULL,'pending'),(42,25,41,'2026-03-27 11:42:45',2700000.00,'cash',NULL,NULL,'','pending'),(43,25,41,'2026-03-27 13:01:01',3108000.00,'cash',NULL,NULL,NULL,'pending'),(44,25,41,'2026-03-27 13:23:39',1056000.00,'bank_transfer','TT041NF','order_1774592619_69c6226b53165.jpg',NULL,'delivered'),(45,25,41,'2026-03-27 13:29:17',524000.00,'cash',NULL,NULL,NULL,'confirmed'),(46,26,44,'2026-03-28 23:45:21',5650000.00,'cash',NULL,NULL,NULL,'confirmed'),(47,26,44,'2026-03-28 23:47:42',68000.00,'bank_transfer','TT046GS','order_1774716462_69c8062e43a89.jpg',NULL,'pending'),(48,26,44,'2026-03-28 23:49:04',1056000.00,'bank_transfer','TT046JP','order_1774716544_69c8068036dda.jpg',NULL,'pending'),(49,26,44,'2026-03-28 23:51:13',1056000.00,'bank_transfer','TT046KD','order_1774716673_69c8070158039.jpg',NULL,'pending'),(50,26,44,'2026-03-28 23:51:39',1056000.00,'cash',NULL,NULL,NULL,'pending'),(51,27,45,'2026-03-29 12:42:14',2580000.00,'cash',NULL,NULL,NULL,'pending'),(52,27,NULL,'2026-03-29 13:03:40',50000.00,'bank_transfer','TT046DI','order_1774764220_69c8c0bcd219c.jpg',NULL,'pending'),(53,27,NULL,'2026-03-29 13:16:58',70000.00,'bank_transfer','TT046BV','order_1774765018_69c8c3da16db9.jpg',NULL,'pending'),(54,27,NULL,'2026-03-29 13:27:51',70000.00,'cash',NULL,NULL,NULL,'pending'),(55,27,45,'2026-03-29 13:28:05',80000.00,'cash',NULL,NULL,NULL,'pending'),(56,27,45,'2026-03-29 13:28:29',1380000.00,'bank_transfer','TT046ZO','order_1774765709_69c8c68d9cb63.jpg',NULL,'pending'),(57,27,45,'2026-03-29 13:29:30',1056000.00,'cash',NULL,NULL,NULL,'pending'),(58,27,45,'2026-03-29 13:29:58',1312500.00,'bank_transfer','TT046LD','order_1774765798_69c8c6e64dbfe.jpg',NULL,'pending'),(59,27,45,'2026-03-29 13:31:20',1056000.00,'bank_transfer','TT046GU','order_1774765880_69c8c7384e3b0.jpg',NULL,'pending'),(60,27,45,'2026-03-29 13:32:07',1056000.00,'bank_transfer','TT046EG','order_1774765927_69c8c767967cf.jpg',NULL,'pending'),(61,27,45,'2026-03-29 13:34:47',1056000.00,'cash',NULL,NULL,NULL,'pending'),(62,27,45,'2026-03-29 13:35:04',1056000.00,'bank_transfer','TT046XB','order_1774766104_69c8c818d3da4.jpg',NULL,'pending'),(63,27,45,'2026-03-29 13:36:26',1123500.00,'bank_transfer','TT046CD','order_1774766186_69c8c86a35e55.jpg',NULL,'pending'),(64,27,45,'2026-03-29 15:07:34',2217000.00,'cash',NULL,NULL,NULL,'pending'),(65,27,45,'2026-03-29 15:24:53',30000.00,'bank_transfer','TT046DH','order_1774772693_69c8e1d51b524.jpg',NULL,'pending'),(66,27,45,'2026-03-29 15:28:13',30000.00,'bank_transfer','TT046UW','order_1774772893_69c8e29dc38b2.jpg',NULL,'pending'),(67,27,45,'2026-03-29 15:32:26',30000.00,'bank_transfer','TT046LD','order_1774773146_69c8e39ac65ef.jpg',NULL,'pending'),(68,27,45,'2026-03-29 15:34:06',30000.00,'cash',NULL,NULL,NULL,'pending'),(69,27,45,'2026-03-29 15:36:15',30000.00,'bank_transfer','TT046CS','order_1774773375_69c8e47f214f5.jpg',NULL,'confirmed'),(70,27,45,'2026-03-29 15:37:24',30000.00,'cash',NULL,NULL,NULL,'confirmed'),(71,27,45,'2026-03-29 15:42:15',30000.00,'bank_transfer','TT046RS','order_1774773735_69c8e5e7e78d1.jpg',NULL,'pending'),(72,27,45,'2026-03-29 15:46:41',30000.00,'cash',NULL,NULL,NULL,'pending'),(73,27,45,'2026-03-29 15:49:00',30000.00,'cash',NULL,NULL,NULL,'pending'),(74,27,45,'2026-03-29 15:50:52',30000.00,'cash',NULL,NULL,NULL,'confirmed'),(75,27,45,'2026-03-29 15:53:26',30000.00,'cash',NULL,NULL,NULL,'pending'),(76,27,45,'2026-03-29 15:56:47',30000.00,'cash',NULL,NULL,NULL,'pending'),(77,27,45,'2026-03-29 15:58:24',1998300.00,'cash',NULL,NULL,NULL,'pending'),(78,27,45,'2026-03-29 16:01:04',1998300.00,'cash',NULL,NULL,NULL,'delivered');
...
INSERT INTO `staff` VALUES (1,13,'Phạm Văn D',NULL,NULL,'Nhân viên tư vấn',5,'active','2026-03-28 03:26:42','2026-03-28 04:18:18'),(2,14,'Hoàng Thị E',NULL,NULL,'Kỹ thuật viên',8,'active','2026-03-28 03:26:42','2026-03-28 04:18:31'),(3,20,'Nguyễn Minh Tuấn',NULL,NULL,'Lễ tân',1,'active','2026-03-28 03:26:42','2026-03-28 04:18:51'),(4,21,'Trần Thanh Hương',NULL,NULL,'Kế toán',7,'active','2026-03-28 03:26:42','2026-03-28 04:19:10'),(5,22,'Lê Văn Hải',NULL,NULL,'Kế toán',3,'active','2026-03-28 03:26:42','2026-03-28 04:12:09'),(7,32,'Bẻo',NULL,NULL,'Huấn luyện viên (PT)',2,'active','2026-03-28 03:44:09','2026-03-28 04:21:37');
...
INSERT INTO `trainers` VALUES (1,'Trương Trung Kiên',NULL,'Nội bộ','0786026822','hoạt động'),(2,'Ngô Gia Phúc',NULL,'Nội bộ','0786026878','hoạt động'),(3,'Nguyễn Nguyên Bảo',NULL,'Nội bộ','07860263336','hoạt động'),(7,'Hoàng Thị Lan',NULL,'Nội bộ','0786026888','hoạt động'),(8,'Hoàng Thị Lan',NULL,'Nội bộ','03333333333','hoạt động');
...
-- Seed view-only from legacy role_permissions if legacy tables exist.
SET @has_legacy_permission_tables := (
  SELECT COUNT(*)
  FROM INFORMATION_SCHEMA.TABLES
  WHERE TABLE_SCHEMA = DATABASE()
    AND TABLE_NAME IN ('role_permissions', 'permissions')
);

SET @seed_role_action_sql := IF(
  @has_legacy_permission_tables = 2,
  'INSERT INTO role_action_permissions (role_id, permission_code, can_view, can_add, can_edit, can_delete)
   ...
   LEFT JOIN role_action_permissions rap
     ...
     AND rap.permission_code = p.code
   WHERE rap.id IS NULL',
  'SELECT 1'
);

PREPARE stmt_seed_role_action_permissions FROM @seed_role_action_sql;
EXECUTE stmt_seed_role_action_permissions;
DEALLOCATE PREPARE stmt_seed_role_action_permissions;
...
-- Dump completed on 2026-03-29 16:02:54
