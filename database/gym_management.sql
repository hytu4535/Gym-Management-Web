...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Thiết bị phòng Gym';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `equipment` VALUES (1,'a',100,'dang su dung'),(2,'dddd',5,'bao tri'),(3,'666666',333,'bao tri');
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Lịch sử bảo trì thiết bị';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `equipment_maintenance` VALUES (2,2,'2026-03-17','ggg','dang_bao_tri'),(3,3,'2026-04-02','FRFGFG','cho_bao_tri');
...
CREATE TABLE `face_checkin_logs` (
  ...
  `captured_image_path` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Dumping data for table `face_checkin_logs`
--

LOCK TABLES `face_checkin_logs` WRITE;
/*!40000 ALTER TABLE `face_checkin_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `face_checkin_logs` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `import_details` VALUES (1,1,1,NULL,2,26000000.00),(2,2,NULL,1,10,1500000.00),(3,4,NULL,19,10,800001.00),(4,6,NULL,18,15,500001.00),(5,6,NULL,13,5,185001.00),(6,7,NULL,19,12,800000.00),(7,8,NULL,19,100,1000000.00),(8,9,NULL,19,30,1000000.00),(9,10,NULL,4,40,500000.00),(12,13,NULL,16,11,111111.00),(13,14,NULL,16,3,50000.00),(14,15,NULL,19,100,1000000.00),(15,16,NULL,19,15,500000.00),(16,17,1,NULL,88,88888.00);
...
INSERT INTO `import_slips` VALUES (1,1,1,52000000.00,'2024-02-01 08:30:00','Nhập máy chạy bộ mới','Đã nhập'),(2,1,2,15000000.00,'2024-02-02 09:00:00','Nhập bổ sung Whey','Đã nhập'),(3,5,1,80000000.00,'2026-03-02 18:51:00','h','Đã nhập'),(4,2,2,8000010.00,'2026-03-11 17:37:00','lllllll','Đã nhập'),(5,3,1,100000.00,'2026-03-23 02:53:00','ssssssssss','Đã hủy'),(6,5,1,8425020.00,'2026-03-23 02:57:00','fffffffffffffff','Đã nhập'),(7,1,23,9600000.00,'2026-03-25 20:51:00','aaaaaaaaaaaaaaa','Đã nhập'),(8,7,24,100000000.00,'2026-03-29 15:35:00','aaaaaaaaaaaaaaaaaaaaaaaaaa','Đã nhập'),(9,2,24,30000000.00,'2026-03-29 21:22:00','','Đã nhập'),(10,3,23,20000000.00,'2026-03-30 17:34:00','aaaaaaaaaaaaaaaaaa','Đã nhập'),(13,13,24,1222221.00,'2026-03-31 00:31:00','aaaaaa','Đã nhập'),(14,5,23,150000.00,'2026-03-26 21:21:00','','Đã nhập'),(15,14,2,100000000.00,'2026-04-01 01:25:28','s','Đã nhập'),(16,14,23,7500000.00,'2026-04-01 02:18:37','aaaaaaaaaaaaaaaaa','Đã nhập'),(17,14,2,7822144.00,'2026-04-01 19:25:22','','Đã nhập');
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Hội viên đăng ký dinh dưỡng';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `member_nutrition_plans` VALUES (1,2,1,'2026-02-19','2026-02-21','kết thúc'),(2,1,2,'2026-03-18','2026-03-28','kết thúc'),(3,19,1,'2026-03-26','2026-04-04','đã áp dụng'),(4,41,8,'2026-03-31','2026-04-30','đã áp dụng'),(5,36,2,'2026-04-01','2026-04-28','đã áp dụng'),(6,41,2,'2026-04-01','2026-04-15','đã áp dụng');
...
INSERT INTO `member_packages` VALUES (1,13,1,'2025-02-06','2025-03-06','cancelled'),(2,3,2,'2026-02-10','2026-05-10','active'),(3,1,3,'2026-03-18','2026-09-18','active'),(4,1,2,'2026-03-22','2026-06-22','active'),(5,1,4,'2026-03-25','2027-03-25','active'),(6,19,7,'2026-03-25','2026-04-25','active'),(7,27,3,'2026-03-29','2026-09-29','active'),(8,27,7,'2026-03-12','2028-03-12','active'),(9,27,7,'2026-03-12','2028-03-12','active'),(10,27,7,'2026-03-12','2028-03-12','active'),(11,32,2,'2026-03-29','2026-06-29','active'),(13,36,12,'2026-03-30','2026-04-30','cancelled'),(15,36,12,'2026-03-31','2026-08-31','active'),(16,25,15,'2026-03-31','2026-07-01','cancelled'),(17,25,7,'2026-03-31','2029-02-19','active'),(18,41,17,'2026-04-01','2026-05-01','active');
...
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Hội viên sử dụng dịch vụ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `member_services` VALUES (1,2,4,'2026-02-19','2026-02-20','đã dùng'),(2,1,4,'2026-03-18',NULL,'còn hiệu lực'),(3,26,5,'2026-03-28',NULL,'còn hiệu lực'),(8,36,4,'2026-03-31','2026-05-01','còn hiệu lực'),(9,36,5,'2026-03-31','2026-05-01','đã dùng'),(12,36,5,'2026-03-31','2026-05-01','bị hủy'),(13,36,5,'2026-03-31','2026-05-01','bị hủy'),(14,36,5,'2026-03-31','2026-05-01','bị hủy'),(15,36,5,'2026-03-31','2026-05-01','bị hủy'),(17,36,5,'2026-03-31','2026-05-01','bị hủy'),(18,36,5,'2026-03-31','2026-05-01','bị hủy'),(19,36,5,'2026-03-31','2026-04-10','bị hủy'),(20,36,5,'2026-03-31','2026-04-11','đã dùng'),(21,36,5,'2026-03-31','2026-05-01','bị hủy'),(22,36,5,'2026-03-31','2026-05-01','bị hủy'),(23,36,5,'2026-03-31','2026-05-01','bị hủy'),(24,36,5,'2026-03-31','2026-05-01','bị hủy'),(25,36,5,'2026-03-31','2026-05-01','còn hiệu lực'),(26,36,3,'2026-03-31','2026-05-01','còn hiệu lực'),(27,32,5,'2026-03-31','2026-05-01','còn hiệu lực'),(28,41,5,'2026-04-01','2026-05-01','còn hiệu lực');
...
CREATE TABLE `members` (
  ...
  `face_consent_source` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_member_user` (`users_id`),
...
INSERT INTO `members` VALUES (1,1,'Trương Trung Kiên','0912345678','18/16 Phan Văn Trị, P.Chợ Quán, Q.5, TPHCM','2024-01-15','active',0,NULL,NULL,175.00,100.00,4,41579375.00),(2,2,'Nguyễn Tường Huy','0987654321','Quận 3, TP.HCM','2024-02-20','active',0,NULL,NULL,180.00,70.00,3,23390000.00),(3,3,'Nguyễn Nguyên Bảo','0903456789','Thủ Đức, TP.HCM','2023-11-05','active',0,NULL,NULL,175.00,75.00,2,3882000.00),(13,9,'test','0786026878','666 Võ Văn Kiệt, Gò Vấp, TP.HCM','2026-02-15','active',0,NULL,NULL,180.00,55.00,1,0.00),(18,25,'ý ý','0786026878',NULL,'2026-03-25','active',0,NULL,NULL,175.00,55.00,3,10242000.00),(19,27,'k','0786026878','','2026-03-25','active',0,NULL,NULL,156.00,56.00,2,7304000.00),(22,23,'kkkk','0786026878',NULL,'2026-03-26','active',0,NULL,NULL,156.00,76.00,1,0.00),(24,32,'Bẻo','09999999999',NULL,'2026-03-26','active',0,NULL,NULL,166.00,66.00,1,0.00),(25,34,'h3','0786026870',NULL,'2026-03-26','active',0,NULL,NULL,190.00,80.00,3,11552300.00),(26,37,'nty4','0786026878','','2026-03-28','active',0,NULL,NULL,0.00,0.00,2,8886000.00),(27,38,'nty5','0912345674',NULL,'2026-03-29','active',0,NULL,NULL,180.00,56.00,3,20517900.00),(28,39,'h6','0917267033','','2026-03-29','active',0,NULL,NULL,0.00,0.00,1,0.00),(29,40,'H7','0786026878','','2026-03-29','active',0,NULL,NULL,0.00,0.00,1,0.00),(31,42,'nty7','0786026866','','2026-03-29','active',0,NULL,NULL,0.00,0.00,1,0.00),(32,43,'nty8','0812345679','','2026-03-29','active',0,NULL,NULL,175.00,75.00,5,68480962.00),(35,45,'ttk3','0912345678','','2026-03-30','active',0,NULL,NULL,185.00,85.00,1,0.00),(36,46,'ttk4','0123456789','','2026-03-30','active',0,NULL,NULL,70.00,40.00,3,20476920.00),(37,50,'ttk8','0786026866','','2026-04-01','active',0,NULL,NULL,0.00,0.00,1,0.00),(38,53,'ttk10','0786026834',NULL,'2026-04-01','active',0,NULL,NULL,175.00,30.00,39,6780000.00),(40,11,'Trần Thị B','0901234567',NULL,'2026-04-01','active',0,NULL,NULL,100.00,30.00,1,0.00),(41,56,'ttk14','0786026833',NULL,'2026-04-01','active',0,NULL,NULL,130.00,20.00,1,1380000.00),(42,57,'ttk15','0786026822',NULL,'2026-04-01','active',0,NULL,NULL,190.00,75.00,1,0.00);
...
CREATE TABLE `nutrition_plans` (
  ...
  `status` enum('hoạt động','không hoạt động') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'hoạt động',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Chế độ dinh dưỡng & tư vấn';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `orders` (
  ...
  KEY `idx_orders_confirmed_by` (`confirmed_by`),
...
INSERT INTO `orders` VALUES (1,1,1,'2026-02-18 09:15:00',250000.00,'cash',NULL,NULL,NULL,'delivered',NULL,NULL),(8,1,11,'2026-02-18 18:50:10',100000.00,'cash',NULL,NULL,NULL,'delivered',NULL,NULL),(9,2,12,'2026-02-18 11:45:00',125000.00,'cash',NULL,NULL,NULL,'delivered',NULL,NULL),(10,2,13,'2026-02-18 13:00:00',99000.99,'online',NULL,NULL,NULL,'confirmed',NULL,NULL),(11,3,14,'2026-02-18 14:20:00',760000.00,'cash',NULL,NULL,NULL,'cancelled',NULL,NULL),(12,2,NULL,'2026-03-08 05:01:30',1380000.00,'online',NULL,NULL,NULL,'delivered',NULL,NULL),(13,2,NULL,'2026-03-08 05:02:31',1380000.00,'cash',NULL,NULL,NULL,'cancelled',NULL,NULL),(14,2,27,'2026-03-08 05:05:14',1380000.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(15,2,NULL,'2026-03-08 05:08:05',1380000.00,'online',NULL,NULL,NULL,'pending',NULL,NULL),(16,2,NULL,'2026-03-08 06:08:05',13530000.00,'cash',NULL,NULL,NULL,'delivered',NULL,NULL),(17,2,NULL,'2026-03-08 06:12:37',18530000.00,'cash',NULL,NULL,NULL,'cancelled',NULL,NULL),(18,2,NULL,'2026-03-08 06:15:07',40000.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(19,2,NULL,'2026-03-08 06:15:28',40000.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(20,2,NULL,'2026-03-08 06:16:29',580000.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(21,1,NULL,'2026-03-11 16:58:19',6780000.00,'cash',NULL,NULL,NULL,'delivered',NULL,NULL),(22,1,NULL,'2026-03-11 17:25:47',3492750.00,'cash',NULL,NULL,NULL,'delivered',NULL,NULL),(23,1,NULL,'2026-03-11 17:29:29',2217000.00,'cash',NULL,NULL,NULL,'delivered',NULL,NULL),(24,3,NULL,'2026-03-11 17:35:28',2082000.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(25,1,NULL,'2026-03-18 18:51:49',3436500.00,'online',NULL,NULL,NULL,'confirmed',NULL,NULL),(26,1,NULL,'2026-03-23 03:00:03',255000.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(27,1,NULL,'2026-03-23 03:18:59',1350000.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(28,1,NULL,'2026-03-23 04:10:32',1200000.00,'bank_transfer','TT028IA','order_1774213832_69c05ac8ab9e1.jpg',NULL,'pending',NULL,NULL),(29,1,NULL,'2026-03-23 04:13:55',556500.00,'bank_transfer','TT028GN','order_1774214035_69c05b93451ad.jpg',NULL,'delivered',NULL,NULL),(30,1,NULL,'2026-03-23 04:15:44',1785000.00,'bank_transfer','TT028LF','order_1774214144_69c05c00a5157.jpg',NULL,'pending',NULL,NULL),(31,1,NULL,'2026-03-23 04:17:37',1785000.00,'bank_transfer','TT028VC','order_1774214257_69c05c713271d.jpg',NULL,'pending',NULL,NULL),(32,1,NULL,'2026-03-23 04:22:54',7522500.00,'bank_transfer','TT028OM','order_1774214574_69c05daebda06.jpg',NULL,'confirmed',NULL,NULL),(33,1,NULL,'2026-03-25 19:59:20',5446625.00,'bank_transfer','TT033HS','order_1774443560_69c3dc2843fd5.jpg',NULL,'pending',NULL,NULL),(34,1,NULL,'2026-03-25 22:10:27',1127500.00,'bank_transfer','TT034AY','order_1774451427_69c3fae3b0271.jpg',NULL,'pending',NULL,NULL),(35,1,NULL,'2026-03-25 22:11:49',2125000.00,'bank_transfer','TT034IH','order_1774451509_69c3fb3544040.jpg',NULL,'pending',NULL,NULL),(36,18,28,'2026-03-25 22:29:16',8130000.00,'bank_transfer','TT034OC','order_1774452556_69c3ff4c9f383.jpg',NULL,'pending',NULL,NULL),(37,18,NULL,'2026-03-25 22:38:12',1056000.00,'cash',NULL,NULL,NULL,'confirmed',NULL,NULL),(38,18,NULL,'2026-03-25 22:39:48',1056000.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(39,19,31,'2026-03-26 04:50:44',2724000.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(40,19,40,'2026-03-26 16:38:23',4580000.00,'cash',NULL,NULL,NULL,'delivered',NULL,NULL),(41,25,41,'2026-03-27 11:33:32',1350000.00,'bank_transfer','TT041EE','order_1774586012_69c6089c948e6.jpg',NULL,'pending',NULL,NULL),(42,25,41,'2026-03-27 11:42:45',2700000.00,'cash',NULL,NULL,'','pending',NULL,NULL),(43,25,41,'2026-03-27 13:01:01',3108000.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(44,25,41,'2026-03-27 13:23:39',1056000.00,'bank_transfer','TT041NF','order_1774592619_69c6226b53165.jpg',NULL,'delivered',NULL,NULL),(45,25,41,'2026-03-27 13:29:17',524000.00,'cash',NULL,NULL,NULL,'confirmed',NULL,NULL),(46,26,44,'2026-03-28 23:45:21',5650000.00,'cash',NULL,NULL,NULL,'confirmed',NULL,NULL),(47,26,44,'2026-03-28 23:47:42',68000.00,'bank_transfer','TT046GS','order_1774716462_69c8062e43a89.jpg',NULL,'pending',NULL,NULL),(48,26,44,'2026-03-28 23:49:04',1056000.00,'bank_transfer','TT046JP','order_1774716544_69c8068036dda.jpg',NULL,'pending',NULL,NULL),(49,26,44,'2026-03-28 23:51:13',1056000.00,'bank_transfer','TT046KD','order_1774716673_69c8070158039.jpg',NULL,'pending',NULL,NULL),(50,26,44,'2026-03-28 23:51:39',1056000.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(51,27,45,'2026-03-29 12:42:14',2580000.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(52,27,NULL,'2026-03-29 13:03:40',50000.00,'bank_transfer','TT046DI','order_1774764220_69c8c0bcd219c.jpg',NULL,'pending',NULL,NULL),(53,27,NULL,'2026-03-29 13:16:58',70000.00,'bank_transfer','TT046BV','order_1774765018_69c8c3da16db9.jpg',NULL,'pending',NULL,NULL),(54,27,NULL,'2026-03-29 13:27:51',70000.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(55,27,45,'2026-03-29 13:28:05',80000.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(56,27,45,'2026-03-29 13:28:29',1380000.00,'bank_transfer','TT046ZO','order_1774765709_69c8c68d9cb63.jpg',NULL,'pending',NULL,NULL),(57,27,45,'2026-03-29 13:29:30',1056000.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(58,27,45,'2026-03-29 13:29:58',1312500.00,'bank_transfer','TT046LD','order_1774765798_69c8c6e64dbfe.jpg',NULL,'pending',NULL,NULL),(59,27,45,'2026-03-29 13:31:20',1056000.00,'bank_transfer','TT046GU','order_1774765880_69c8c7384e3b0.jpg',NULL,'pending',NULL,NULL),(60,27,45,'2026-03-29 13:32:07',1056000.00,'bank_transfer','TT046EG','order_1774765927_69c8c767967cf.jpg',NULL,'pending',NULL,NULL),(61,27,45,'2026-03-29 13:34:47',1056000.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(62,27,45,'2026-03-29 13:35:04',1056000.00,'bank_transfer','TT046XB','order_1774766104_69c8c818d3da4.jpg',NULL,'pending',NULL,NULL),(63,27,45,'2026-03-29 13:36:26',1123500.00,'bank_transfer','TT046CD','order_1774766186_69c8c86a35e55.jpg',NULL,'pending',NULL,NULL),(64,27,45,'2026-03-29 15:07:34',2217000.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(65,27,45,'2026-03-29 15:24:53',30000.00,'bank_transfer','TT046DH','order_1774772693_69c8e1d51b524.jpg',NULL,'pending',NULL,NULL),(66,27,45,'2026-03-29 15:28:13',30000.00,'bank_transfer','TT046UW','order_1774772893_69c8e29dc38b2.jpg',NULL,'pending',NULL,NULL),(67,27,45,'2026-03-29 15:32:26',30000.00,'bank_transfer','TT046LD','order_1774773146_69c8e39ac65ef.jpg',NULL,'pending',NULL,NULL),(68,27,45,'2026-03-29 15:34:06',30000.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(69,27,45,'2026-03-29 15:36:15',30000.00,'bank_transfer','TT046CS','order_1774773375_69c8e47f214f5.jpg',NULL,'confirmed',NULL,NULL),(70,27,45,'2026-03-29 15:37:24',30000.00,'cash',NULL,NULL,NULL,'confirmed',NULL,NULL),(71,27,45,'2026-03-29 15:42:15',30000.00,'bank_transfer','TT046RS','order_1774773735_69c8e5e7e78d1.jpg',NULL,'pending',NULL,NULL),(72,27,45,'2026-03-29 15:46:41',30000.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(73,27,45,'2026-03-29 15:49:00',30000.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(74,27,45,'2026-03-29 15:50:52',30000.00,'cash',NULL,NULL,NULL,'confirmed',NULL,NULL),(75,27,45,'2026-03-29 15:53:26',30000.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(76,27,45,'2026-03-29 15:56:47',30000.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(77,27,45,'2026-03-29 15:58:24',1998300.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(78,27,45,'2026-03-29 16:01:04',1998300.00,'cash',NULL,NULL,NULL,'delivered',NULL,NULL),(79,27,45,'2026-03-29 16:17:10',1998300.00,'bank_transfer','TT046DB','order_1774775830_69c8ee16242d0.jpg',NULL,'pending',NULL,NULL),(80,32,46,'2026-03-29 16:21:34',12180000.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(81,32,46,'2026-03-29 16:27:31',29554500.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(82,32,46,'2026-03-29 16:28:39',24902062.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(83,32,46,'2026-03-29 16:36:34',1844400.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(84,32,46,'2026-03-29 21:03:33',1239600.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(85,32,46,'2026-03-29 21:20:22',1585200.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(86,32,46,'2026-03-29 23:34:26',3038000.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(87,32,NULL,'2026-03-30 00:00:57',1080000.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(88,35,50,'2026-03-30 16:02:05',6780000.00,'cash',NULL,NULL,NULL,'confirmed',NULL,NULL),(89,35,50,'2026-03-30 16:10:46',1380000.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(90,36,51,'2026-03-30 16:57:18',4080000.00,'cash',NULL,NULL,NULL,'confirmed',NULL,NULL),(91,36,51,'2026-03-30 17:15:10',4903500.00,'cash',NULL,NULL,NULL,'confirmed',NULL,NULL),(92,36,51,'2026-03-30 17:35:13',109420.00,'bank_transfer','TT088FD','order_1774866913_69ca51e1a43d3.png','zzzzzzzzzzzzzzzzzzzzz','confirmed',NULL,NULL),(93,36,NULL,'2026-03-30 22:36:33',380000.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(94,36,NULL,'2026-03-30 22:37:50',380000.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(95,36,NULL,'2026-03-30 22:42:07',38000.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(96,36,NULL,'2026-03-31 16:26:15',22800.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(97,36,NULL,'2026-03-31 17:00:32',1900000.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(98,36,51,'2026-03-31 17:08:52',727300.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(99,36,51,'2026-03-31 17:10:17',1004700.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(100,36,51,'2026-03-31 17:11:57',679800.00,'cash',NULL,NULL,NULL,'delivered',NULL,17),(101,36,NULL,'2026-03-31 17:17:58',380000.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(102,36,NULL,'2026-03-31 17:27:36',337778.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(104,36,NULL,'2026-03-31 17:56:16',114000.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(105,36,NULL,'2026-03-31 17:56:51',91200.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(106,36,NULL,'2026-03-31 17:57:33',3800000.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(107,36,NULL,'2026-03-31 18:09:19',3800000.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(108,36,NULL,'2026-03-31 18:09:32',3800000.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(109,36,NULL,'2026-03-31 18:11:47',4750000.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(110,36,NULL,'2026-03-31 18:12:05',3800000.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(111,36,NULL,'2026-03-31 18:12:35',4750000.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(112,36,NULL,'2026-03-31 18:13:50',4750000.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(113,36,NULL,'2026-03-31 18:13:59',4750000.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(114,36,NULL,'2026-03-31 18:14:10',3800000.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(115,36,NULL,'2026-03-31 18:23:40',3800000.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(116,36,NULL,'2026-03-31 18:23:48',3800000.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(117,36,NULL,'2026-03-31 18:43:55',3800000.00,'cash',NULL,NULL,NULL,'cancelled',NULL,NULL),(118,36,NULL,'2026-03-31 18:55:16',4750000.00,'cash',NULL,NULL,NULL,'confirmed',NULL,17),(119,36,51,'2026-03-31 18:56:08',5954200.00,'bank_transfer','TT096AR','order_1774958168_69cbb65815018.jpg',NULL,'delivered',NULL,17),(120,32,49,'2026-03-31 21:53:06',4844000.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(121,25,41,'2026-03-31 22:29:25',104100.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(122,25,NULL,'2026-03-31 22:40:07',6460000.00,'bank_transfer','TT096KN','order_1774971607_69cbead75fe44.jpg',NULL,'pending',NULL,NULL),(123,25,41,'2026-03-31 22:51:39',2954100.00,'cash',NULL,NULL,NULL,'confirmed',NULL,NULL),(124,25,41,'2026-04-01 01:52:04',1004700.00,'cash',NULL,NULL,NULL,'delivered',NULL,34),(125,25,41,'2026-04-01 02:07:58',2676000.00,'cash',NULL,NULL,NULL,'delivered',34,34),(126,25,41,'2026-04-01 02:12:33',3337500.00,'cash',NULL,NULL,NULL,'delivered',34,34),(127,38,52,'2026-04-01 17:14:27',6780000.00,'cash',NULL,NULL,NULL,'delivered',53,54),(128,41,53,'2026-04-01 18:24:09',1380000.00,'cash',NULL,NULL,NULL,'confirmed',17,NULL),(129,41,NULL,'2026-04-01 19:30:39',50000.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL),(130,41,NULL,'2026-04-01 19:32:18',5000000.00,'cash',NULL,NULL,NULL,'pending',NULL,NULL);
...
CREATE TABLE `products` (
  ...
  `unit` enum('cái','hộp','chai','gói','kg','lít') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'cái' COMMENT 'Đơn vị tính: cái, hộp, chai, gói, kg, lít',
...
INSERT INTO `role_permissions` VALUES (4,1),(4,2),(11,2),(4,3),(11,3),(4,4),(11,4),(4,5),(11,5),(4,6),(11,6),(4,7),(11,7),(18,7),(4,8),(11,8),(15,8),(4,9),(11,9),(4,10),(11,10),(4,11),(11,11),(4,12),(11,12);
...
CREATE TABLE `services` (
  ...
  `status` enum('hoạt động','không hoạt động') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'hoạt động',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Dịch vụ phòng gym';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `services` VALUES (3,'Massage phục hồi sau tập','assets/uploads/services/service_1774445517_3e958b4e.jpg','xoa bóp',100000.00,'Tập hết mình, relax hết cỡ! Dịch vụ mát-xa tại gym giúp bạn giảm đau cơ, thư giãn tức thì và phục hồi nhanh hơn. Không gian chill, kỹ thuật viên chuyên nghiệp.','hoạt động'),(4,'Xông hơi sauna – thư giãn chuẩn gym','assets/uploads/services/service_1774445765_fb6ca8a3.jpg','thư giãn',120000.00,'Giải nhiệt sau buổi tập với phòng xông hơi hiện đại, giúp thải độc, giảm căng cơ và thư giãn cực đã. Không gian sạch đẹp, ấm áp – “reset” cơ thể nhanh chóng.','hoạt động'),(5,'xông hơi Sauna + anh Kiên massage','assets/uploads/services/service_1774445956_0a536abf.jpg','thư giãn',5000000.00,'Xông hơi sauna giúp thải độc, giảm căng cơ, thư giãn cực đã sau buổi tập. Sau đó được anh Kiên trực tiếp massage, đánh tan đau mỏi, làm xong nhẹ người liền.','hoạt động'),(7,'Chi14','assets/uploads/services/service_1775041379_70f34127.png','thư giãn',1000000.00,'Được chị 14 phục vụ tận tình tận tâm hỗ trợ xoa bóp.','hoạt động');
...
CREATE TABLE `staff` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_staff_user` (`users_id`),
  KEY `users_id` (`users_id`),
...
INSERT INTO `suppliers` VALUES (1,'Công ty Thể Thao Đại Việt','0901234567','123 Lý Thường Kiệt, Q10, TP.HCM','active','2024-01-27 10:00:00'),(2,'Whey Store VN','0909888777','456 CMT8, Q3, TP.HCM','active','2024-01-27 10:00:00'),(23,'Công ty TNHH Thiết Bị Minh Phát','0908123456','125 Nguyễn Văn Cừ, Quận 5, TP. Hồ Chí Minh','active','2026-03-24 12:50:09'),(24,'Công ty TNHH Thiết Bị Minh Phát','0908123456','125 Nguyễn Văn Cừ, Quận 5, TP. Hồ Chí Minh','active','2026-03-24 12:50:10');
...
-- Dump completed on 2026-04-01 19:35:17
